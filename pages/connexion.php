...
<?php
	...
	{ 
            //echo 'cookies de marqueur vide<br/>';
            if(!isset($_COOKIE['CookieSeSouvenirDeMoi']))
            {
                //echo "cookies souvenir de moi vide";
                        ...
                        <div class="table table-bordered">
                            ...
                            <form action="index.php?page=connexion.php" method="POST" class="form-horizontal cadre">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="IdentifiantSansSouvenir" name="Identifiant" placeholder="Votre identifiant">
                                  </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group"> 
                                  <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <span class="legerement_a_droite aqua">
                                        <input type="checkbox" name="maCheckBox" value="souvenir">Se souvenir de moi<br>
                                    </span>
                        ...
                        if(isset($_POST['Envoyer']))
                        {
                            if($_POST['Identifiant']!="" && $_POST['mdp']!="")
                            {
                                ...
                                {   
                                    ...
                                    $timestamp_marque = time() + 86400; // On le marque pendant une minute 
                                    $cookie_vie = time() + 60*60*24; // Durée de vie de 24 heures pour le décalage horaire
                                    setcookie("CookieSeSouvenirDeMoi", $timestamp_marque, $cookie_vie);
        ...
        {
            //echo "cookies souvenir de moi remplie";
                if(!isset($_SESSION['nombre']))
                {
                    // Initialisation de la variable 
                    $_SESSION['nombre'] = 0;
                ...
                <div class='legerement_a_droite'>
                    <div class="container largeur">
                        ...
                        <div class="table table-bordered">
                            ...
                            <form action="index.php?page=connexion.php" id="ajax-contact" method="POST" class="form-horizontal cadre">

                                <div class="form-group">
                                  <label class="control-label col-sm-2 evidence" for="Identifiant">Identifiant :</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="IdentifiantAvecSouvenir" name="Identifiant" placeholder="Votre identifiant">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-2 evidence" for="mdp">Mot de passe :</label>
                                  <div class="col-sm-10"> 
                                      <input type="password" class="form-control" id="password" name="mdp" placeholder="Votre mot de passe">
                                  </div>
                                </div>
                                <div class="form-group"> 
                                  <div class="col-sm-offset-2 col-sm-10">
